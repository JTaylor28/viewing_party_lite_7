...
RSpec.describe "movie's detail page", type: :feature do
  ...
  describe "when I visit the movie destails page" do
    ...
    it "should have movie details" do
      ...
      expect(page).to have_content("Spanning the years 1945 to 1955, a chronicle of the 
                                    fictional Italian-American Corleone crime family. When organized crime family patriarch, 
                                    Vito Corleone barely survives an attempt on his life, his youngest son, Michael steps in 
